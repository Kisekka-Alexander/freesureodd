...
export default function CountryPredictionsPage() {
  ...
  const { country: countryName } = parseCountryParams(params.country as string);
  ...
  useEffect(() => {
    const title = `${selectedCountry} Football Predictions - SureWin`;
  ...
  const handleCountryFilter = (country: string | null) => {
    if (country !== selectedCountry) {
      // Navigate to different country or home
      if (country) {
                ...
                <div className="flex justify-center items-center py-20">
                  <div className="text-center">
                    ...
                    <span className="text-lg text-gray-600">
                      Loading {selectedCountry} predictions...
                    </span>
              ...
              {!loading && !error && filteredPredictions.length === 0 && (
                <div className="text-center py-20">
                  ...
                  <p className="text-gray-600 text-xl mb-4">
                    No predictions found for {selectedCountry}.
                  </p>
                  ...
                  <div className="flex flex-col md:flex-row justify-between items-center mb-6">
                    <div className="flex flex-col md:flex-row md:items-center gap-4 mb-4 md:mb-0">
                      <div className="text-sm text-gray-600">
                        Showing {filteredPredictions.length} predictions from{" "}
