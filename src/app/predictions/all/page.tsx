...
export default function AllPredictionsPage() {
  ...
  useEffect(() => {
    const title = "All Football Predictions - SureWin";
  ...
  const handleCountryFilter = (country: string | null) => {
    if (country) {
      ...
      router.push(`/predictions/${countrySlug}`);
    }
  };
              ...
              {!loading && !error && filteredPredictions.length === 0 && (
                <div className="text-center py-20">
                  ...
                  <p className="text-gray-500">
                    Check back later for fresh predictions and analysis.
                  </p>
                </div>
              )}
                  ...
                  <div className="flex flex-col md:flex-row justify-between items-center mb-6">
                    <div className="flex flex-col md:flex-row md:items-center gap-4 mb-4 md:mb-0">
                      <div className="text-sm text-gray-600">
                        Showing all {filteredPredictions.length} predictions
                        {selectedDate && selectedDate !== getTodayLocalDate() && (
                          <>
                            {" "}on{" "}
